...
(function () {
  ...
  if (fadeElements.length > 0 && 'IntersectionObserver' in window) {
    var observer = new IntersectionObserver(function (entries) {
      ...
      // A page can contain one very tall section (for example, the complete
      // publication list). Reveal it as soon as any part enters the viewport;
      // requiring a percentage of the whole section can be impossible.
      threshold: 0,
  ...
  document.addEventListener('keydown', function (e) {
    ...
    if (e.key === 'Tab' && searchOverlay && searchOverlay.classList.contains('open')) {
