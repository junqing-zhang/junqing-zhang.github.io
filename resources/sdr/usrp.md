...
This page summarises information for Universal Software Radio Peripheral (USRP).
...
It is strongly recommended to use pybombs to install gnuradio and UHD in Ubuntu. Instructions can be found [GNU Radio resource](https://www.gnuradio.org/blog/2016-06-19-pybombs-the-what-the-how-and-the-why/){:target="_blank"}
