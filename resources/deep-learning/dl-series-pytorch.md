...
# Resources:
* Check a full example [MNIST handwritten digit classification with MLPs](https://github.com/CSCfi/machine-learning-scripts/blob/master/notebooks/pytorch-mnist-mlp.ipynb)

Depending on your preference of the programming languages, there are Python and Matlab examples available for MNIST.
