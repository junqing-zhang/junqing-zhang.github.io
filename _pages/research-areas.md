...
* [Key Generation from Wireless Channels]:(keygen_main.md) Key generation is an emerging technique to establish cryptographic keys between legitimate users by extracting randomness from their common channels.
