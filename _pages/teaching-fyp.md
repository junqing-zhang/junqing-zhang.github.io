...
* Involve wireless technologies including [Wi-Fi](/resources/wireless/wifi/), [LoRa/LoRaWAN](/resources/wireless/lora-lorawan/), [ZigBee](/resources/wireless/zigbee/), and [Bluetooth](/resources/wireless/bluetooth/);
...
* Device Authentication for Wi-Fi Using Deep Learning and Radio Frequency Fingerprint
...
* LoRa-Based Key Generation in Low Power Wide Area Networks
* Gesture Recognition Using Deep Learning and mmWave Sensor
* [Gesture Recognition Using Deep Learning and Wi-Fi](https://github.com/Z-Yannn/FYP-Gesture-Recognition-Using-Deep-Learning-and-Wi-Fi){:target="_blank"}

## 2021
* Deep Learning and mmWave Sensor-based Gesture Recognition
* [Deep Learning and Wi-Fi-based Gesture Recognition](https://github.com/Zilliax-Barry/FYP_Deep-Learning-and-WiFi-based-Gesture-Recognition){:target="_blank"}
* Device Authentication for Wi-Fi based on Deep Learning and Radio Frequency Fingerprint Using SDR
...
* Deep Learning based RFF Identification for Wi-Fi
